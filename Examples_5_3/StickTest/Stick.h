...
// Generated at "C:\src\lua\luastick\LuaStick\src\LuaStick.cpp"(6792)
template<>
...
/// Generated at "C:\src\lua\luastick\LuaStick\src\LuaStick.cpp"(6876)
/// </summary>
/// <param name="L">The l.</param>
/// <param name="data">The data.</param>
/// <returns>Number of arguments</returns>
...
/// <returns>Number of arguments</returns>
template<typename ... Args>
int stick_pusharg(lua_State* L, void* data, ::X::Enum3&& head, Args&& ... args)
{
	Sticklib::push_lvalue<__int64>(L, (__int64)head, false);
	return stick_pusharg(L, data, std::move(args)...) + 1;
}
...
/// <returns>Number of arguments</returns>
template<typename ... Args>
int stick_pusharg(lua_State* L, void* data, const ::X::Enum3&& head, Args&& ... args)
{
	Sticklib::push_lvalue<__int64>(L, (__int64)head, false);
	return stick_pusharg(L, data, std::move(args)...) + 1;
}
